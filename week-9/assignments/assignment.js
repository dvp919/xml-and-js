...
loadData(`http://192.168.0.145:8080/week-6/assignments/people.xml`).then((data) => renderTable(data));
...
const onSubmit = (event) => {
    ...
    console.log(term);
    loadData(`http://192.168.0.145:8080/week-6/assignments/people.xml`).then((data) => renderTable(data, term));
}
